...
export default class DetailSmartTV extends React.Component {
    ...
    selectSubtitles() {
        return (
            <Modal
                transparent={true}
                visible={this.state.selectSubtitles}
            >
                <View style={{
                    ...
                    >
                        <View style={{
                            ...
                            <View style={{ backgroundColor: '#fff', borderBottomRightRadius: 20, borderBottomLeftRadius: 20, alignItems: 'center', paddingVertical: 20 }}>
                                <TouchableOpacity
                    ...
                    <View style={{ marginTop: Constants.statusBarHeight + hp('3%'), paddingHorizontal: hp('2%') }}>
                        ...
                        <View style={{ alignItems: 'center', marginTop: hp('4%') }}>
                            <ImageBackground style={{
                                height: hp('52%'), width: width * .75, backgroundColor: '#fff', borderRadius: 20, shadowColor: "#000",
                                shadowOffset: {
                                    width: 0,
                                    height: 2,
                                },
                                ...
                                <View>
                                    ...
                                    <View style={{ alignItems: 'center' }}>
                                        <Image
                                            style={{ width: width * .7, height: hp('21%'), borderRadius: 20 }}
                                            source={require('../../../../../assets/images/lupin-lede.jpg')}
                                        />
