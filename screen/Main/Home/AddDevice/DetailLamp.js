...
export default class DetailLamp extends React.Component {
        ...
        return (
            <View style={styles.container}>
                <View>
                    <View style={{ marginTop: Constants.statusBarHeight + hp('3%'), paddingHorizontal: hp('2%') }}>
                        <View style={{ alignItems: 'center' }}>
                            ...
                            <View style={{ transform: [{ rotate: '-90deg' }], marginTop: hp('14%') }}>
                                <Slider
                                    vertical={true}
                ...
                />
                                ...
                                <View style={{ flex: 0.33, alignItems: 'center' }}>
                                    <TouchableOpacity onPress={()=> this.props.navigation.navigate('SelectSceneLamp')}
                                    style={{
                                        height: hp('7%'),
                                        width: hp('7%'),
                                        alignItems: 'center',
