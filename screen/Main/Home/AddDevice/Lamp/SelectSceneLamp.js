...
export default class SelectSceneLamp extends React.Component {
            ...
            <View style={styles.container}>
                <View>
                    <View style={{ marginTop: Constants.statusBarHeight + hp('3%'), paddingHorizontal: hp('2%') }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: hp('14%') }}>
                    ...
                    <View style={{ position: 'absolute', bottom: -400, right: 0, left: 0, flex: 1 }}>
